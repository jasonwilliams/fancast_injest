...
func API() {
	...
	// Get metadata about recently added podcasts
	router.HandleFunc("/podcasts/new", newPodcastsHandler)
...
// Handle New Podcasts
func newPodcastsHandler(w http.ResponseWriter, r *http.Request) {
	podcasts := models.GetNewPodcasts()
